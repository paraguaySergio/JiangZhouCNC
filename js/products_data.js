                ...
                "detail_description":
                    {
                        "description1": "Función del quinto eje\n" +
                            ...
                            "Control electrónico estándar de la rueda de mano, ajuste y operación fáciles de usar.\n" +
                            " \n" +
                            "Tipo de cable alternativo\n" +
                            "El uso del convertidor de frecuencia para lograr un ajuste continuo de la velocidad del cable, para lograr un funcionamiento suave y con poco ruido.\n" +
                            "Pase el cable utilizando el control PLC para lograr un cable alternativo de carrera variable, avance y retroceso hacia cualquier conjunto.\n" +
                            "Para lograr un corte sin bandas, mejore la calidad de la superficie de la pieza.",
                        "description2": "",
                        "description3": "",
                    }
            }
                ...
                "detail_description":
                    {
                        "description1": "Velocidad de procesamiento de hasta 30 ~ 60 mm por minuto (según el material);\n" +
                            ...
                            "Se puede procesar el orificio de inicio del cortador de alambre, el orificio del filtro, el orificio de la boquilla, la porosidad, el orificio del grupo, el orificio ultra profundo, etc.\n" +
                            "Puede ser recto k en la pendiente de la pieza, procesamiento de superficie;\n" +
                            "Puede cortarse en la pieza de trabajo en el taladro, el grifo, etc., sin dañar el hilo.",
                        "description2": "",
                        "description3": "",
                    }
            },
                ...
                "detail_description":
                    {
                        "description1": "Produje la fresadora CNC con buena rigidez, alta precisión, bajo nivel de ruido, funcionamiento, fácil mantenimiento, precio razonable, etc. Puede fresar automáticamente el plano, ranura, pendiente y una variedad de superficies complejas, así como también orificios de cobalto, escariado, levantamiento, etc., con una amplia gama de aplicaciones y una aplicabilidad más amplia, un rendimiento superior. Especialmente indicado para el procesado de moldes.\n" +
                            " \n" +
                            "El centro de mecanizado puede lograr un enlace de cuatro ejes, cinco ejes, con fresado, taladrado, taladrado, escariado, roscado y otras funciones de procesamiento, puede completar las partes complejas de todo el procesamiento, sistema de alimentación rápida y cambiador de herramientas de alta velocidad, tiempo de corte Asegurar que la máquina tenga una alta eficiencia de producción. Tanto para el procesamiento complejo de moldes de precisión, como también para una variedad de partes de la producción a granel.",
                        "description2": "",
                        "description3": "",
                    }
            }
                ...
                "detail_description":
                    {
                        "description1": "La máquina de lijar se utiliza principalmente para el corte de grafito, electrodo y tablero epoxi, material duro no conductor, mármol, jade, óptica, vidrio, ferrita cerámica, material semiconductor, silicio carbonizado, silicio refractario y otros materiales.\n" +
                            ...
                            "La máquina de línea de arena de la compañía ha sido vendida a muchos fabricantes y clientes nacionales y extranjeros de jade, y en este campo de acceso a una serie de patentes nacionales.",
                        "description2": "",
                        "description3": "",
                    }
            }
